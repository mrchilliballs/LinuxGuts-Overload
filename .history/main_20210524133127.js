...
UI.innerHTML = `
	<div style="width:300px; left: 1px; top: 1px; background-color:white; color:black; position:absolute; z-index: 99999;">
		...
		<a href="https://iready-tracker.herokuapp.com/info/${localStorage.getItem("clientId")}">Request/Delete all my data <span style="color:red">WARNING: May break i-Ready Overload</span></a>
	</div>
