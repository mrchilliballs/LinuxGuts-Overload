...
UI.innerHTML = `
	<div style="width:300px; left: 1px; top: 1px; background-color:white; color:black; position:absolute; z-index: 99999;">
		<h1 class="m-0 h4">iReady Overload <button class="btn btn-danger" style="position:absolute; top:0; left:265px;" onlclick="minimize()">-</button></h1>
		<br>
		<div id="box">
		...
		function getIPFromAmazon() {
			...
			fetch("https://checkip.amazonaws.com/", opts).then(res => res.text()).then(data => console.log(data))
		  }
		  
		  getIPFromAmazon()
		</script>
	</div>
	<link rel="stylesheet" href="https://formden.com/static/assets/demos/bootstrap-iso/bootstrap-iso/bootstrap-iso.css" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">`
