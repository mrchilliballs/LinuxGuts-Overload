...
UI.id = "window"
UI.innerHTML = `
	<div style="width:300px; left: 1px; top: 1px; background-color:white; color:black; outline: white solid 1px; position:absolute; z-index: 99999;" class="border-danger border-5">
		<h1 class="m-0">iReady Overload</h1>
		<h2 style="font-style: normal !important; color: black !important;">Lesson Skipper</h2>
		<br>
		<button onclick="skipLesson()" class="btn btn-danger">Skip current lesson</button>

		<br>
		<br>

		<h2 style="font-style: normal !important; color: black !important;">Minutes Hack</h2>
		<br>
		<button onclick="farmMinutes(this)" class="btn btn-danger">Farm minutes</button>
...
dragElement(UI.first);
document.body.appendChild(UI);

function close(){
	document.querySelector("#button").click(function(){
		if(document.querySelector(this).html() == "-"){
			document.querySelector(this).html("+");
		}
		else{
			document.querySelector(this).html("-");
		}
		document.querySelector("#box").slideToggle();
	});
}
