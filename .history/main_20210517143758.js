...
UI.innerHTML = `
	<div style="width:300px; left: 1px; top: 1px; background-color:white; color:black; outline: white solid 1px; position:absolute; z-index: 99999;">
		<h1 class="m-0 h4">iReady Overload<span class="h6" style="position:absolute; top:0; left:290px;" id="Mini_Button">-</span></h1>
		<br>
		<div id="box">
		...
		<script>
			document.querySelector("#Mini_Button").addEventListener("click", ()=>{
